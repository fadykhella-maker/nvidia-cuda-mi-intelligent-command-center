...
.stApp,[data-testid="stAppViewContainer"],[data-testid="stMain"]{{background:transparent!important;color:#f2f5f2}}[data-testid="stMainBlockContainer"],.main .block-container{{width:min(650px,calc(100vw - 36px))!important;max-width:650px!important;margin:15vh auto 0!important;padding:20px 34px 52px!important;position:relative;z-index:5;background:rgba(8,14,10,.94)!important;border:1.5px solid rgba(255,255,255,.82)!important;border-radius:18px;box-shadow:0 25px 90px #000}}
