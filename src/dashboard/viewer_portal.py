...
.stApp,[data-testid="stAppViewContainer"],[data-testid="stMain"]{{background:transparent!important;color:#f2f5f2}}[data-testid="stMainBlockContainer"],.main .block-container{{width:min(460px,calc(100vw - 32px))!important;max-width:460px!important;margin:14vh auto 0!important;padding:24px 30px 22px!important;position:relative;z-index:5;background:rgba(8,14,10,.93)!important;border:1px solid #36503c!important;border-radius:20px;box-shadow:0 25px 90px #000;backdrop-filter:blur(5px)}}
[data-testid="stMainBlockContainer"]:before,.main .block-container:before{{content:"";display:block;position:relative;z-index:3;width:118px;height:54px;margin:0 auto 10px;background:url('{logo_uri}') center/contain no-repeat}}
