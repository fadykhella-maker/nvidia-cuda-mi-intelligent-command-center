...
.login-card-surface{{position:fixed;z-index:2;left:50%;top:15vh;transform:translateX(-50%);width:min(650px,calc(100vw - 36px));height:440px;background:rgba(8,14,10,.94);border:1px solid #36503c;border-radius:18px;box-shadow:0 25px 90px #000;pointer-events:none}}
