...
.stApp{{background:#010302;color:#f2f5f2}}[data-testid="stMainBlockContainer"],.main .block-container{{width:min(560px,calc(100vw - 36px))!important;max-width:560px!important;margin:11vh auto 0!important;padding:30px 38px 28px!important;position:relative;z-index:5;background:transparent!important;border:0!important;border-radius:24px}}
[data-testid="stMainBlockContainer"]:after,.main .block-container:after{{content:"";position:absolute;inset:0;z-index:1;background:rgba(8,14,10,.93);border:1px solid #36503c;border-radius:24px;box-shadow:0 25px 90px #000;backdrop-filter:blur(5px);pointer-events:none}}
